module.exports = function(RED) {
	...
	function ProxmoxBackupServerNode(n) {
		...
		this.authenticate = function() {
            ...
            return rp(options)
                .then(function (body) {
                    ...
                    self.auth = body.data
                    self.log("Successfully connected to Proxmox Backup Server: " + self.username + "@" + self.host + ":" + self.port);
                    ...
                    self.error("Failed to connect to Proxmox Backup Server");
                    self.error(error);
	...
	RED.nodes.registerType("proxmox-backup-server",ProxmoxBackupServerNode, {
        credentials: {
            username: {type:"text"},
